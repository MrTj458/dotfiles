...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/Comment.nvim",
    url = "https://github.com/numToStr/Comment.nvim"
  },
  LuaSnip = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/LuaSnip",
    url = "https://github.com/L3MON4D3/LuaSnip"
  },
  catppuccin = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/catppuccin",
    url = "https://github.com/catppuccin/vim"
  },
  ["cmp-buffer"] = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/cmp-buffer",
    url = "https://github.com/hrsh7th/cmp-buffer"
  },
  ["cmp-nvim-lsp"] = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp",
    url = "https://github.com/hrsh7th/cmp-nvim-lsp"
  },
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
    url = "https://github.com/hrsh7th/cmp-nvim-lua"
  },
  ["cmp-path"] = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/cmp-path",
    url = "https://github.com/hrsh7th/cmp-path"
  },
  cmp_luasnip = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
  ...
  ["indent-blankline.nvim"] = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/indent-blankline.nvim",
    url = "https://github.com/lukas-reineke/indent-blankline.nvim"
  },
  ["lualine.nvim"] = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/lualine.nvim",
    url = "https://github.com/nvim-lualine/lualine.nvim"
  },
  neoformat = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/neoformat",
  ...
  ["nvim-cmp"] = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/nvim-cmp",
  ...
  ["vim-sleuth"] = {
    loaded = true,
    path = "/home/tj/.local/share/nvim/site/pack/packer/start/vim-sleuth",
